" =============================================================================
" Filename: autoload/lightline/colorscheme/multiply.vim
" Author: Pavan Jadhaw
" License: MIT License
...
let s:p.normal.right = [ [ '#292c33', '#98c379', s:term_black, s:term_green ], [ '#abb2bf', '#3e4452', s:term_green, s:term_black ], [ '#98c379', '#292c33', s:term_green, s:term_black ] ]
let s:p.inactive.right = [ [ '#292c33', '#61afef', s:term_black, s:term_blue], [ '#abb2bf', '#3e4452', s:term_green, s:term_black ] ]
let s:p.inactive.left = s:p.inactive.right[1:]
" her
let s:p.insert.left = [ [ '#292c33', '#61afef', s:term_black, s:term_blue, 'bold' ], [ '#61afef', '#292c33', s:term_blue, s:term_black ] ]
let s:p.insert.right = [ [ '#292c33', '#61afef', s:term_black, s:term_blue ], [ '#ABB2BF', '#3E4452', s:term_green, s:term_black ], [ '#61afef', '#292c33', s:term_blue, s:term_black ] ]
...
let s:p.normal.right = [ [ '#292c33', '#98c379', s:term_black, s:term_green ], [ '#abb2bf', '#3e4452', s:term_green, s:term_black ], [ '#98c379', '#292c33', s:term_green, s:term_black ] ]
let s:p.visual.right = [ [ '#292c33', '#c678dd', s:term_black, s:term_purple, 'bold' ], [ '#abb2bf', '#3e4452', s:term_purple, s:term_black ], [ '#c678dd', '#292c33', s:term_purple, s:term_black ] ]
...
let g:lightline#colorscheme#mltply#palette = lightline#colorscheme#fill(s:p)
